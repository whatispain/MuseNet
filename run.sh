...
#export PYTHONPATH="${PYTHONPATH}:/home/servml/Документы/code/Vladimir/Musenet"  
#export LD_LIBRARY_PATH=$HOME/Документы/code/Vladimir/Musenet/venv-musenet/lib/python3.12/site-packages/nvidia/nvjitlink/lib:$LD_LIBRARY_PATH
#/home/servml/Документы/code/Vladimir/Musenet/University-Release/train/google/1057
...
--data_dir='/home/servml/Документы/code/Vladimir/Musenet/University-Release/train' \
--views=3 \
--droprate=0.5 \
--extra \
--share \
...
python test_iaa.py \
--name='three_view_long_share_d0.5_256_s1_google_lr0.005_spade_v24.11_210ep_weather_0110000_alpha1_test' \
--test_dir='/home/servml/Документы/code/Vladimir/Musenet/University-Release/test' \
--iaa \
--gpu_ids='0'
